          ...
          {!showForm ? (
            ...
            <Card className="border-slate-200 dark:border-slate-700 mb-16">
              <CardContent className="p-10">
                ...
                <div className="mb-8 p-6 rounded-lg bg-gradient-to-r from-emerald-50 to-cyan-50 dark:from-emerald-950/30 dark:to-cyan-950/30 border border-emerald-200 dark:border-emerald-900/30">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-8 h-8 rounded-full bg-emerald-500 text-white flex items-center justify-center font-bold text-sm">
                      {showingAiReview ? "2" : showingBusinessPlan ? "3" : currentStep + 1}
                    </div>
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white">
                      {showingAiReview ? "AI Review of Your Idea - All 43 Questions" : showingBusinessPlan ? "Your Business Plan" : currentStep === 0 ? "Step 1: Your Information" : "Step 2: Tell Us About Your Idea"}
                    </h3>
                  </div>
                  <p className="text-sm text-slate-600 dark:text-slate-300">
                    {showingAiReview ? "Here's a review of all your answers. Edit any section if you'd like to refine it before building your business plan." : showingBusinessPlan ? "Here's the business plan that was generated by AI. Edit each section to customize it for your needs." : currentStep === 0 ? "Let's start with your basic information" : "Help us understand your vision and business opportunity"}
                  </p>
                </div>
