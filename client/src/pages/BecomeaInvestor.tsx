...
export default function BecomeaInvestor() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!contractAgreed) {
      alert("Please read and agree to the Investor Agreement to submit your application");
      return;
    }
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        data-testid="select-investor-country"
                      >
                    ...
                    {formData.country === "United States" && (
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500"
                          data-testid="select-investor-state"
                        >
                    ...
                    <div className="pt-6 border-t border-slate-200 dark:border-slate-700">
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        <label className="text-sm font-semibold text-slate-900 dark:text-white">Investor Agreement *</label>
                      </div>
                      ...
                      <div className="flex items-start gap-3 mt-4">
                        ...
                        >
                          I have read and agree to the <span className="font-semibold text-amber-600 dark:text-amber-400">Investor Agreement</span>
                        </label>
                      </div>
                    </div>
